...
sign-waiver: ##@contributing Sign the WAIVER
	...
	mv AUTHORS/WAIVER.asc AUTHORS/WAIVER-signed-by-$(USERNAME)-$(CURRENT_YEAR).asc
	git add AUTHORS/WAIVER-signed-by-$(USERNAME)-$(CURRENT_YEAR).asc
	git commit AUTHORS/WAIVER-signed-by-$(USERNAME)-$(CURRENT_YEAR).asc -s -S -m 'Sign WAIVER by $(USERNAME)'
